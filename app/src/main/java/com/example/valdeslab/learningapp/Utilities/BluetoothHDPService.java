...
public class BluetoothHDPService extends Service {
    ...
    public void onCreate() {
        ...
        // Get the default adapter (Bluetooth radio) This is how the app interacts with bluetooth -dvj
        mBluetoothAdapter = BluetoothAdapter.getDefaultAdapter();
        // Verify that the device supports bluetooth and is enabled -dvj
        ...
        // Check for service listener - dvj
     ...
     * This notifies bluetooth profile when it has been connected or disconnected from the service
     * -dvj
     */
    ...
    private class ReadThread extends Thread {
        ...
        public void run() {
            ...
            byte data[] = new byte[116];  //final byte data[] = new byte[8192]; - This is original
